...
const Branches = () => {
    ...
    const onSubmit = async(data) => {
        try {
            ...
            const response = await fetch('http://127.0.0.1:8000/api/sucursale', {
              method: 'POST',
              headers: {
